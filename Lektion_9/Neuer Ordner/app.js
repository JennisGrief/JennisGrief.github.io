...
(function (L08_Canvas_Alley) {
    ...
    function handleLoad(_event) {
        ...
        var streetWidthBack = 100;
        var streetWidthFront = 600;
        var treesOffsetBack = 15;
        var treesOffsetFront = 100;
        var posMountains = { x: 0, y: horizon };
        var posStreet = { x: crc2.canvas.width / 2, y: horizon };
        var posTreesStart = { x: posStreet.x - streetWidthBack / 2 - treesOffsetBack, y: horizon };
        var posTreesEnd = { x: crc2.canvas.width / 2 - streetWidthFront / 2 - treesOffsetFront, y: crc2.canvas.height };
        drawBackground();
        drawSun({ x: 100, y: 75 });
    ...
    function drawTrees(_nTrees, _posStart, _posEnd, _minScale, _stepPos, _stepScale) {
        ...
        var transform = crc2.getTransform();
        var step = {
