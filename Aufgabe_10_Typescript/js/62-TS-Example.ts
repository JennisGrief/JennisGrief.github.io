// Und los ghet die wilde Fahrt meine Freunde.
interface Monster {
    ...
    monsterItem : string;  // Monster Item, viel mehr  als dorschh braucht es da allerdings nicht!
...
{
    let tempMonsterXP : number = 100 + getRNGNumber(420);  // Diese Funktion gibt eine zufällige ganze Zahl (zwischen 0 und 350) + 100 zurück.
